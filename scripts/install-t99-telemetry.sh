...
files="usr/share/vtmodem/qmi.uc usr/share/vtmodem/t99-radio.uc usr/share/vtmodem/t99-session.uc usr/share/vtmodem/qmi-status.uc $rpc $ui"
...
# Accept stock build 49, the verified r2/r3 hotfixes, or this exact bundle.
check_base "$rpc" \
	...
	cb6ff9a9ce2cfb9379d44c988fb4929f543823e19a2ea93b1226c9883842d5e1
check_base "$ui" \
	...
	133b0c822ce1449201d4740ad432b708cc5ed00ca82cc0e122068757f516d9e8
...
if [ -e /usr/share/vtmodem/qmi-status.uc ]; then
	check_base usr/share/vtmodem/qmi-status.uc \
		...
		b5f9275b891a6ba8ace09dc2839da699c047dbbe44dbec1d8939ac1d6ce49692
fi
if [ -e /usr/share/vtmodem/t99-radio.uc ]; then
	check_base usr/share/vtmodem/t99-radio.uc \
		4bdfdce01982848c38cbcab24f4b26c2b0a5818d02a9a28e67f832926fcec992
fi
if [ -e /usr/share/vtmodem/t99-session.uc ]; then
	check_base usr/share/vtmodem/t99-session.uc
fi
...
ucode scripts/tests/test-t99-session.uc
